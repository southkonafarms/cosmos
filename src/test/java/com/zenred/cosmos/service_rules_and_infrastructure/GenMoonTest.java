...
public class GenMoonTest {

	private static Logger logger = Logger.getLogger(GenMoonTest.class);
	...
	public void test() {
		...
		List<Planetoid> moonsList = new ArrayList<Planetoid>();
		...
		// cleanup
		logger.info("Cleaning up Moons");
		for(Planetoid planetoid : moonsList){
